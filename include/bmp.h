...
** Last update Tue Feb  7 22:20:41 2017 Nicolas Polomack
*/
...
void		write_pixel_buffer(t_my_framebuffer *, int);
bmp_header	set_header(bmp_header, t_my_framebuffer *);
bmp_info_header	set_info(bmp_info_header, t_my_framebuffer *);
