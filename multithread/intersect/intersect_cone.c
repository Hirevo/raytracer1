...
** Last update Mon Feb 20 11:03:22 2017 Nicolas Polomack
*/
...
void	calc_abcd(float *abcd, sfVector3f *restrict eye_pos, sfVector3f *restrict dir_vector,
		  t_obj *obj)
{
...
float		intersect_cone(sfVector3f *restrict eye_pos, sfVector3f *restrict dir_vector,
			       t_obj *obj)
{
  float		abcd[4];
  float		root[4];
...
float		intersect_closed_cone(sfVector3f *restrict eye_pos, sfVector3f *restrict dir_vector,
