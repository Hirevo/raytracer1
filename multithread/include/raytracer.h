...
** Last update Fri Mar 17 11:16:44 2017 Nicolas Polomack
*/
...
void		calc_focal_vector(t_thread *, float, float);
...
** lights.c
*/
void	sub_coords_vect(sfVector3f *restrict,
			sfVector3f *restrict, t_obj *);
void	add_coords_vect(sfVector3f *restrict,
			sfVector3f *restrict, t_obj *);
float	intersect_light(t_thread *, sfVector3f, sfVector3f);
